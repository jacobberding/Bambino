...
const Global = (function () {
    ...
    const isStudio = function () {
        return ($(`m-body[aria-label="Studio"]`).length > 0) ? true : false;
    }
    ...
    const init = function () {
        ...
        if (!Global.isMobile()) {
            $(document).on('mouseenter', '.tooltip', function (e) { 
                ...
                $(`body`).append(`<m-tooltip style="left: ${left}px;top: ${parseInt($(this).offset().top + 15)}px;">${$(this).attr(`aria-label`)}</m-tooltip>`); 
