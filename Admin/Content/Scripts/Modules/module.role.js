...
const Role = (function () {
    ...
    const _delete = function ($this) {
        ...
        Global.post(`Member_DeleteRole`, vm)
            .done(function (data) {
                ...
                $(`m-card[data-id="${vm.roleId}"]`).remove();
    ...
    const getHtmlTag = function (obj) {
        return `
            ...
            <m-card class="tag" data-id="${obj.roleId}">
                <m-flex data-type="row" class="n">
                    <h1 class="tE">
                        ${obj.name}
                    </h1>
                    <m-flex data-type="row" class="n c xs sQ tertiary btnDelete${_self.name}" data-id="${obj.roleId}">
