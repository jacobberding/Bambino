        ...
        return `
            ...
            <m-flex data-type="row" class="s n">
                ...
                <m-flex data-type="col" class="w n">
                    ...
                    <m-flex data-type="row" class="n wR s">

                        ${Global.jack.mIA ? `
                        <m-button data-type="secondary" class="sQ btnOpenBody" data-label="Primary" data-function="TimeTrackerProject.getHtmlBody" data-args="${_self.vm.projectId}">
                            Time Sheets
                        </m-button>` : ``}
